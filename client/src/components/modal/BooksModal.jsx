...
export default function BooksModal({small}) {
    ...
    return ReactDom.createPortal(
        <div className='modalBackground' onClick={closeBooksModal}>
            <div className={`customizeScroll bg-gray-50 w-64 h-96 overflow-y-scroll fixed ${small ? 'top-6':`${isFullScreen?'top-8':'top-20'}`} left-1/2 transform -translate-x-1/2 translate-y-1 shadow-sm`} onClick={(e)=>e.stopPropagation()}>
